...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Norberto_Ullrich',
      password: '1lqLI8SA8BWOcHw',
      email: 'Duncan.Ferry5@yahoo.com',
      name: 'Grady Hessel',
      mobileNo: '1-846-760-7100 x91291',
      userType: 526,
      resetPasswordLink: {},
      loginRetryLimit: 66,
      loginReactiveTime: '2022-07-08T13:59:11.804Z',
      id: '623c55163301b05d493fb8fe'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Evangeline.Schmidt35',
        'password':'Ycdh1XqvbnyQBKZ',
        'email':'Cornelius.Cummings@gmail.com',
        'name':'Leigh Lind',
        'mobileNo':'507.400.2580 x4045',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    ...
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Cornelius.Cummings@gmail.com', });
