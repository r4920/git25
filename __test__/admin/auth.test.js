...
beforeAll(async function (){
  try {
    ...
    inserted_user = await user.insertOne({
      username: 'Mervin.Reynolds',
      password: 'TF7qgDRA1YL45sM',
      email: 'Griffin_Gusikowski66@hotmail.com',
      name: 'Elijah Tromp DVM',
      mobileNo: '532.950.2850',
      userType: 353,
      resetPasswordLink: {},
      loginRetryLimit: 172,
      loginReactiveTime: '2022-04-10T11:52:28.608Z',
      id: '623c55163301b05d493fb8da'
    });
  }
  catch (err) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Javon93',
        'password':'4zlqQIiLNYq9DXA',
        'email':'Gerson92@yahoo.com',
        'name':'Dr. Cora Sauer',
        'mobileNo':'792.488.9683 x75274',
